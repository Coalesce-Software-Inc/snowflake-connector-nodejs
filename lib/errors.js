...
/** Coalesce added */
// 899001
codes.ERR_CONN_CREATE_INVALID_LOG_FUNCTION_COALESCE = 899001;
 ...
 * @param {Number} errorCode the error code to use when building the error.
 * @param {Object} [isFatal] whether the error is fatal.
 * @param {Object} [cause] The cause of the client error, if there was one
 *
 * @return {Error}
 */
exports.createClientErrorWithCause = function (errorCode, isFatal, cause)
{
  return createError(errorTypes.ClientError,
    {
      code: errorCode,
